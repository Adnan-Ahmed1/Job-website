...
<body>
        ...
        <header class="main-header">
                <div class="container header-container">
                        ...
                        <div class="logo">
                                <div class="logo-text">
                                        <span class="logo-title c-green">FASTJOB</span>
                                        <span class="logo-title-sub">S E A R C H E R S</span>
                        ...
                        <div class="header-search">
                                ...
                                <button class="search-btn bg-green">Search</button>
                        </div>

                        <!-- Actions -->
                        <div class="header-actions">
                                <a href="javascript:void(0);" class="header-social-btn telegram-btn-outline"><i class="fab fa-telegram-plane c-blue"></i> Telegram</a>
                                <a href="javascript:void(0);" class="header-social-btn whatsapp-btn-outline"><i class="fab fa-whatsapp c-green"></i> WhatsApp</a>
                        </div>
                </div>
        </header>
                ...
                <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="mainNavbar">
                                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                                        ...
                                        <li class="nav-item">
                                                <a class="nav-link <?php echo ($current_page == 'job.php') ? 'active' : ''; ?>" href="job.php">Jobs</a>
                                        </li>
                                        <li class="nav-item">
                                                <a class="nav-link <?php echo ($current_page == 'result.php') ? 'active' : ''; ?>" href="result.php">Results</a>
                                        </li>
                                        <li class="nav-item">
                                                <a class="nav-link <?php echo ($current_page == 'admit-card.php') ? 'active' : ''; ?>" href="admit-card.php">Admit Card</a>
                                        </li>

                                        <li class="nav-item has-mega-menu">
                                                <a class="nav-link <?php echo ($current_page == 'answer-key.php') ? 'active' : ''; ?>"
                                                        href="answer-key.php">Answer Key <i class="fas fa-chevron-down ms-1"></i></a>
                                                <div class="mega-menu">
                                        ...
                                        <li class="nav-item">
                                                <a class="nav-link <?php echo ($current_page == 'syllabus.php') ? 'active' : ''; ?>" href="syllabus.php">Syllabus</a>
                                        </li>
                                        <li class="nav-item">
                                                <a class="nav-link <?php echo ($current_page == 'admission.php') ? 'active' : ''; ?>" href="admission.php">Admission</a>
                                        </li>
                                        <li class="nav-item">
                                                <a class="nav-link <?php echo ($current_page == 'scholarship.php') ? 'active' : ''; ?>" href="scholarship.php">Scholarship</a>
                                        </li>

                                        <li class="nav-item has-mega-menu">
                                                <a class="nav-link <?php echo ($current_page == 'question-paper.php') ? 'active' : ''; ?>"
                                                        href="question-paper.php">Question Paper <i class="fas fa-chevron-down ms-1"></i></a>
                                                <div class="mega-menu">
                                                        <div class="mega-menu-content">
                                                                <div class="mega-menu-col">
                                                                        <div class="mega-col-header">
                                                                                ...
                                                                                <div class="mega-search-wrapper">
                                                                                        <i class="fas fa-search"></i>
                                                                                        <input type="text" class="mega-search-input"
                                                                                                placeholder="Search All State Boards...">
                                                                                </div>
                                                                        </div>
                                                                        <ul>
                                                                                <li>
                                                                ...
                                                                <div class="mega-menu-col">
                                                                        <div class="mega-col-header">
                                                                                ...
                                                                                <div class="mega-search-wrapper">
                                                                                        <i class="fas fa-search"></i>
                                                                                        <input type="text" class="mega-search-input"
                                                                                                placeholder="Search State Wise Universities...">
                                                                                </div>
                                                                        </div>
                                                                        <ul>
                                                                                <li>
                                                                ...
                                                                <div class="mega-menu-col">
                                                                        ...
                                                                        <ul>
                                                                                <li><a href="question-paper.php?tab=ssc">SSC CGL</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">SSC CHSL</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">SSC MTS</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">SSC GD Constable</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">SSC CPO</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">SSC Stenographer</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">IBPS PO</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">IBPS Clerk</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">SBI PO</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">SBI Clerk</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">RBI Grade B</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">RBI Assistant</a></li>
                                                                                <li><a href="question-paper.php?tab=railway">RRB NTPC</a></li>
                                                                                <li><a href="question-paper.php?tab=railway">RRB Group D</a></li>
                                                                                <li><a href="question-paper.php?tab=railway">RRB ALP</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">UPSC CSE</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">UPSC NDA/CDS</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">UPPSC PCS</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">BPSC</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">RPSC RAS</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">MPPSC</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">UP Police Constable</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">Delhi Police Constable</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">CTET</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">UPTET / STET</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">DSSSB Exams</a></li>
                                                                                <li><a href="question-paper.php?tab=ssc">KVS / NVS Exams</a></li>
                                                                        </ul>
                                                                </div>
                                                                <div class="mega-menu-col">
                                                                        <div class="mega-col-header">
                                                                                ...
                                                                                <div class="mega-search-wrapper">
                                                                                        <i class="fas fa-search"></i>
                                                                                        <input type="text" class="mega-search-input"
                                                                                                placeholder="Search All Entrance Exams...">
                                                                                </div>
                                                                        </div>
                                                                        <ul>
                                                                                <li><a href="question-paper.php?alert=entrance">JEE Main</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">JEE Advanced</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">NEET UG</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">NEET PG</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">CUET UG</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">CUET PG</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">CAT</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">MAT</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">XAT / SNAP</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">CLAT</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">AILET</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">GATE</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">BITSAT</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">VITEEE</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">SRMJEEE</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">MHT CET</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">KCET</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">WBJEE</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">UPSEE / AKTU</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">TS EAMCET</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">AP EAMCET</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">KEAM</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">State B.Ed Entrance</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">JEECUP (Polytechnic)</a></li>
                                                                                <li><a href="question-paper.php?alert=entrance">BCECE</a></li>
                                                                        </ul>
                                                                </div>
                                                        </div>
                                                </div>
                                        ...
                                        <li class="nav-item">
                                                <a class="nav-link <?php echo ($current_page == 'yojana.php') ? 'active' : ''; ?>" href="yojana.php">Yojana</a>
                                        </li>
                                        <li class="nav-item">
                                                <a class="nav-link <?php echo ($current_page == 'document.php') ? 'active' : ''; ?>" href="document.php">Document</a>
                                        </li>
                                </ul>
                        </div>
                </div>
